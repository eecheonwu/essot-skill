# ESSOT SSOT Sync Orchestrator Skill
...
*   **Engineering Intelligence Platform (ESSOT):** The centralized web application that tracks your project's architecture, documentation, and engineering artifacts.
